            ...
            <a class="navbar-brand d-flex align-items-center" href="index.php">
              ...
              xecution
                ...
                <a class="navbar-brand" href="#index.php" style="margin-left: 10%">
                    <img src="assets/images/logo_star-removebg-preview.png" alt="Logo" title="logo" class="main_logo" />
                </a>
        ...
        <div class="container py-lg-5 py-sm-4">
            <div class="row align-items-center">
                <div class="col-lg-6 content-image order-lg-first order-last">
                    <a href="#image"><img src="assets/images/about_img.jpg" class="img-responsive"
                            alt="content-photo" /></a>
                </div>
        ...
        <div class="container py-md-5 py-4">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-6 item" id="consulting">
                    <div class="card">
                        <div class="card-header p-0 position-relative border-0">
                            <img class="d-block img-responsive" src="assets/images/consulting.jpg" alt="card-image" />
                        </div>
                ...
                <div class="col-lg-4 col-md-6 mt-lg-0 mt-4" id="marketing">
                    <div class="card">
                        <div class="card-header p-0 position-relative border-0">
                            <img class="d-block img-responsive" src="assets/images/marketing.jpg" alt="card-image" />
                        </div>
                        <div class="card-body service-details">
                ...
                <div class="col-lg-4 col-md-6 mt-lg-0 mt-4 card-top" id="brokerage">
                    <div class="card">
                        <div class="card-header p-0 position-relative border-0">
                            <img class="d-block img-responsive" src="assets/images/Brokerage.jpg" alt="card-image" />
                        </div>
                        <div class="card-body service-details">
                            <!-- <span class="label-style label-style-3">Corporate</span> -->
                ...
                <div class="col-lg-4 col-md-6 mt-lg-0 mt-4 card-top" id="research">
                    <div class="card">
                        <div class="card-header p-0 position-relative border-0">
                            <img class="d-block img-responsive" src="assets/images/research.jpg" alt="card-image" />
                        </div>
                        <div class="card-body service-details">
                            <!-- <span class="label-style label-style-3">Corporate</span> -->
                ...
                <div class="col-lg-3 col-sm-12">
                    <div class="team-block-single">
                        <div class="team-grids">
                            <a href="#team-single">
                                <img src="assets/images/olufade_omolara.jpg" class="img-fluid" alt="" />
            ...
            ?>
              ...
              ?>
                ...
                ?>
                        ...
                        <option value="<?php echo $row['courses']; ?>"><?php echo $row['courses']; ?> -
                            £<?php echo number_format($row['price']); ?></option>
                        <?php } ?>
                    </select>
            ...
            <div class="row sub-columns">
                <div class="col-lg-4 col-sm-12 sub-one-left">
                    ...
                    <div class="columns-2">
                        <ul class="social">
                            <li>
                                <a href="http://Facebook.com/starsnbloom" target="_blank" title="facebook"><span
                                        class="fab fa-facebook-f" aria-hidden="true"></span></a>
                            </li>
                            <li>
                                <a href="#linkedin" target="_blank" title="linkedin"><span class="fab fa-linkedin-in"
                                        aria-hidden="true"></span></a>
                            </li>
                            <li>
                                <a href="http://Twitter.com/Starsandbloom" target="_blank" title="twitter"><span
                                        class="fab fa-twitter" aria-hidden="true"></span></a>
                            </li>
                            <li>
                                <a href="#google" target="_blank" title="google"><span class="fab fa-google-plus-g"
                                        aria-hidden="true"></span></a>
                            </li>
                            <li>
                                <a href="http://Instagram.com/starsnbloom" target="_blank" title="instagram"><span
                                        class="fab fa-instagram" aria-hidden="true"></span></a>
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6 sub-two-right pl-lg-5 mt-lg-0 mt-sm-5 mt-5">
                    <h6>Our Services</h6>
                    <ul>
                        <li>
                            <a href="#consulting"><span class="fas fa-angle-right mr-2"></span>Consulting</a>
                        </li>
                        <li>
                            <a href="#training"><span class="fas fa-angle-right mr-2"></span>Training</a>
                        </li>
                        <li>
                            <a href="#marketing"><span class="fas fa-angle-right mr-2"></span>Marketing</a>
                        </li>
                        <li>
                            <a href="#brokerage"><span class="fas fa-angle-right mr-2"></span>Brokerage</a>
                        </li>
                        <li>
                            <a href="#research"><span class="fas fa-angle-right mr-2"></span>Research</a>
                        </li>
                    </ul>
                </div>
                <div class="col-lg-4 col-sm-6 sub-two-right mt-lg-0 mt-sm-5 mt-4">
                    ...
                    <ul>
                        <li>
                            <a href="#home"><span class="fas fa-angle-right mr-2"></span>Home</a>
                        </li>
                        <li>
                            <a href="#about"><span class="fas fa-angle-right mr-2"></span>About</a>
                        </li>
                        <li>
                            <a href="#service"><span class="fas fa-angle-right mr-2"></span>Services</a>
                        </li>
                        <a href="#ourteam"><span class="fas fa-angle-right mr-2"></span> Our Team</a>
                        </li>
                        <li>
                            <a href="#contact"><span class="fas fa-angle-right mr-2"></span>Contact</a>
                        </li>
                    </ul>
                </div>
                <!-- <div
